...
public class MyJMapFrame extends JFrame {
    ...
    /**
     * Default constructor. Creates a {@code MyJMapFrame} with
    ...
    /**
     * Constructs a new {@code MyJMapFrame} object with specified map content.
     *
     * @param content the map content
     */
     ...
     * calling {@link #enableTool} with all {@link MyJMapFrame.Tool}
     * constants.
     * 
     ...
     * by {@link MyJMapFrame.Tool} constants.
     * 
     * <code><pre>
